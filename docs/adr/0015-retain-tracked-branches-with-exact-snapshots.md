...
Accepted for Tracked Branch retention in issue #49. This decision amends ADR 0003's retained Selection Intent inventory by adding the optional canonical Tracked Branch identity; exact-commit Pi package delegation remains unchanged. Issue #50 added candidate adoption, and ADR 0016 in issue #51 defines structural candidate identity and coalescing. Background availability remains deferred.
